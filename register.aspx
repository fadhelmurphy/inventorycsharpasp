<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="SistemBarang.register" %>
...
<form id="form1" runat="server" cssClass="form-signin">
                <h1 class="h3 mb-3 font-weight-normal text-center">Register Page</h1>
    ...
    <asp:Button ID="Register" runat="server" CssClass="btn btn-lg btn-primary btn-block" Text="Register" OnClick="Register_Click" />
</form>
                       </div>
    </div>
    </div>
