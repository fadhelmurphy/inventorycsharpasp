<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Restok.aspx.cs" Inherits="SistemBarang.RestokBarang" %>
...
<header>
    ...
    <form id="form1" runat="server">
        ...
        <ul class="list-group">
            ...
            <a class="list-group-item list-group-item-action flex-column align-items-start text-secondary active" href="Restok.aspx">
                Restok
            </a>
            ...
            <h1 class="pr-4">Penyetokan Barang</h1>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="TabelRestokbarang" runat="server" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="id" HeaderText="Nomor Transaksi"/>
                                ...
                                <asp:BoundField DataField="penyuplai" HeaderText="Penyuplai"/>
                                <asp:BoundField DataField="jumlah" HeaderText="Jumlah Direstok"/>
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <button type="button" class="btn btn-sm btn-info" 
                                            onclick="editGet(this,'<%# DataBinder.Eval(Container.DataItem,"idBarang") %>','<%# DataBinder.Eval(Container.DataItem,"idPenyuplai")%>')"
                ...
                <!--Modal bootstrap goes here!-->

                <div class="modal fade" id="AddForm" tabindex="-1" role="dialog" aria-labelledby="DelFormLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 id="judulForm">Tambah Rekaman</h5>
                            </div>
                            <div class="modal-body">
                                <div id="IdHide" hidden="hidden">
                                    <label for="IdPenyetokan">ID Penyetokan</label>
                                    <asp:TextBox ID="IdPenyetokan" runat="server" CssClass="form-control"></asp:TextBox>
                                    <br />
                                </div>
                                ...
                                <label for="IdPenyulai">Penyuplai</label>
                                <asp:DropDownList ID="IdPenyuplai" runat="server" CssClass="form-control"></asp:DropDownList>
                                <br />
                ...
                <div class="modal fade" id="DelForm" tabindex="-1" role="dialog" aria-labelledby="DelFormLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <label for="IdPenyetokanDel">Kode Penyetokan</label>
                                <asp:TextBox ID="IdPenyetokanDel" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
    ...
    <script>
        //setup modal supaya berfungsi sebagai modal Edit
        function editGet(obj, idBarang, idPenyuplai) {
            ...
            document.getElementById("IdPenyetokan").setAttribute("readonly", "readonly");
            document.getElementById("IdPenyetokan").value = getRow.childNodes.item(2).innerText;;
            document.getElementById("IdBarang").value = idBarang;
            document.getElementById("IdPenyuplai").value = idPenyuplai;
            document.getElementById("Jumlah").value = getRow.childNodes.item(7).innerText;
        ...
        function addClear() {
            ...
            document.getElementById("IdPenyetokan").value = null;
            document.getElementById("IdBarang").selectedIndex = 0; 
            document.getElementById("IdPenyuplai").selectedIndex = 0; 
            document.getElementById("Jumlah").value = null;
            document.getElementById("Tanggal").value = null;
        }
        function delGet(obj) {
            document.getElementById("IdPenyetokanDel").setAttribute("readonly", "readonly");
            document.getElementById("IdPenyetokanDel").value = obj.parentElement.parentElement.childNodes.item(2).innerText;;
        }
